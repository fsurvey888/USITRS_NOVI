          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex gap-5">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Удружење је првобитно основано у јануару 1998. године под називом ДИТ (Друштво инжењера и техничара).
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex gap-5">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  „Удружење шумарских инжењера и техничара Републике Српске". Од 2004. године, функцију првог
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex gap-5">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Предсједник Скупштине био је Милорад Јагодић све до посљедње Скупштине, када је на ту функцију
